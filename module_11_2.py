...
def introspection_info(obj):
    ...
    # Получения типа объекта
    object_type = type(obj).__name__

    # Получения атрибутов объекта
    attribute = dir(obj)

    # Получения методов объекта
    ...
    # Инициация словаря с информацией об объекте
    info = {'тип': object_type, "атрибуты": attribute, "методы": methods, "модули": module}
...
# Интроспекция списка
list_info = introspection_info([1, 20, 4.0, 'string'])
print(list_info)
